...
var form = {
    ...
    elem: [
        ...
        {id: "find_out", name: "find-out"},
        {id: "file_format", name: "file-format-required"},
        {id: "file_example", name: "file-example"},
        {id: "puid", name: "puid"},
        {id: "references", name: "references"},
        {id: "other_information", name: "other-information"}
    ],
    regex : /^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,
    emails: [
