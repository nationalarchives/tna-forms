 ...
 * ------------------------------------------------------------------------------
 * Letters of no evidence qUnit tests
 * ------------------------------------------------------------------------------
 */
...
var form = {
    fixture: "fixture",
    id: "letters_of_no_evidence",
    submitName: "submit-letters-of-no-evidence",
    submitId: "submit-tna-form",
    typeSubmit: "input[type=submit]",
    typeHidden: "input[type=hidden]",
    elem: [
        {id: "full_name", name: "full-name-required"},
        {id: "alternative_names", name: "alternative-names"},
        {id: "date_of_birth", name: "date-of-birth-required"},
        {id: "date_of_death", name: "date_of_death"},
        {id: "country_of_birth", name: "country-of-birth"},
        {id: "full_name_contact_details", name: "full-name-contact-details-required"},
        {id: "email", name: "email-required"},
        {id: "confirm_email", name: "confirm-email-required"},
        {id: "postal_address", name: "postal-address-required"}
    ],
    regex : /^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/,
    emails: [
