...
function return_form_paid_search($content)
{
    ...
    $form =  $html->form_begins( 'paid_search', $form_name, 'novalidate' ) .
             ...
             $html->form_textarea_input('Your enquiry', 'enquiry', 'enquiry', 'Please provide specific details of the information you are looking for, including any relevant catalogue references.') .
