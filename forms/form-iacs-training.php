...
function return_form_iacs_training( $session_title, $session_options ) {
	...
	$form =  $html->form_begins( 'iacs_training', 'Information Assurance and Cyber Security training' ) .
	         ...
	         $html->form_select_input( 'Session (1st choice)', 'session_first_choice', 'session-first-choice', $session_options, 'Please select an option', $session_title ) .
	         $html->form_select_input( 'Session (2nd choice)', 'session_second_choice', 'session-second-choice', $session_options, 'Please select an option', $session_title ) .
