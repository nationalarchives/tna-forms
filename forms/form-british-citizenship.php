	            ...
	            <form action=""  id="naturalisation" class="form-abandonment" method="POST">
	                ...
	                <fieldset class="form-step-1">
	                    ...
	                    <div class="form-row">
	                        ...
	                        <input type="text" id="certificate_first_name" name="certificate-first-name" aria-required="true" required ' . set_value( 'certificate-first-name' ) . '>
	                    ...
	                    <div class="form-row">
	                        ...
	                        <input type="text" id="certificate_last_name" name="certificate-last-name" aria-required="true" required ' . set_value( 'certificate-last-name' ) . '>
