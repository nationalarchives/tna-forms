...
class Form_Processor
{
    ...
    {
        if (is_array($data)) {
            $display_data = '<div style="background:#eee; border:1px solid #ccc; padding:20px; ">';
            foreach ($data as $field_name => $field_value) {
                if (strpos($field_name,
                        'skype-name') !== false || $field_name == 'confirm-email-required' || $field_name == 'confirm-email'
                ) {
            ...
            $display_data .= '&lt;enquiry_id&gt;' . $ref_number . '&lt;&sol;enquiry_id&gt;<br>&lt;full_name&gt;' . $data['full-name-required'] . '&lt;&sol;full_name&gt;<br>
                    &lt;alternative_name&gt;' . $data['alternative-names'] . '&lt;&sol;alternative_name&gt;<br>
                    &lt;birth_date&gt;' . $data['date-of-birth-required'] . '&lt;&sol;birth_date&gt;<br>
                    &lt;death_date&gt;' . $data['date_of_death'] . '&lt;&sol;death_date&gt;<br>
                    &lt;country_of_birth&gt;' . $data['country-of-birth'] . '&lt;&sol;country_of_birth&gt;<br>
                    &lt;contact_full_name&gt;' . $data['full-name-contact-details-required'] . '&lt;&sol;contact_full_name&gt;<br>
                    &lt;contact_email&gt;' . $data['email-required'] . '&lt;&sol;contact_email&gt;<br>
                    &lt;contact_address&gt;' . $data['postal-address-required'] . '&lt;&sol;contact_address &gt;';
