module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            dist: {
                src: ['js/tna-validation.js', 'js/forms/inc/methods.js', 'js/forms/tna-naturalisation-form.js', 'js/forms/tna-default-form.js', 'js/forms/tna-records-research-enquiry-form.js', 'js/tna-call-plugin.js' ],
